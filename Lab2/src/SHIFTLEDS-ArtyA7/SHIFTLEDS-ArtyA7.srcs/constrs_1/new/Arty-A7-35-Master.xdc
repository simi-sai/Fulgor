...
set_property -dict { PACKAGE_PIN A8    IOSTANDARD LVCMOS33 } [get_ports { switch[0] }]; #IO_L12N_T1_MRCC_16 Sch=i_sw[0]
set_property -dict { PACKAGE_PIN C11   IOSTANDARD LVCMOS33 } [get_ports { switch[1] }]; #IO_L13P_T2_MRCC_16 Sch=i_sw[1]
set_property -dict { PACKAGE_PIN C10   IOSTANDARD LVCMOS33 } [get_ports { switch[2] }]; #IO_L13N_T2_MRCC_16 Sch=i_sw[2]
set_property -dict { PACKAGE_PIN A10   IOSTANDARD LVCMOS33 } [get_ports { switch[3] }]; #IO_L14P_T2_SRCC_16 Sch=i_sw[3]
...
set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { B_LED[3] }]; #IO_L23P_T3_35 Sch=led3_b
set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { G_LED[3] }]; #IO_L24P_T3_35 Sch=led3_g
##set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { R_LED[3] }]; #IO_L23N_T3_35 Sch=led3_r

##LEDs

set_property -dict { PACKAGE_PIN H5    IOSTANDARD LVCMOS33 } [get_ports { LED[0] }]; #IO_L24N_T3_35 Sch=o_led[4]
set_property -dict { PACKAGE_PIN J5    IOSTANDARD LVCMOS33 } [get_ports { LED[1] }]; #IO_25_35 Sch=o_led[5]
set_property -dict { PACKAGE_PIN T9    IOSTANDARD LVCMOS33 } [get_ports { LED[2] }]; #IO_L24P_T3_A01_D17_14 Sch=o_led[6]
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { LED[3] }]; #IO_L24N_T3_A00_D16_14 Sch=o_led[7]
...
set_property -dict { PACKAGE_PIN C2    IOSTANDARD LVCMOS33 } [get_ports { ext_reset }]; #IO_L16P_T2_35 Sch=ck_rst
